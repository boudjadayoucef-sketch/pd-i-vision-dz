...
const startKey = 'const tooltipData: { [key: string]: { title: string; desc: string } } = {';
const endKey = 'onClick={() => setShowTechnicalReport(true)}';
...
// Find line start for startIndex
...
content = content.substring(0, lineStart) + replacementCode + content.substring(endIndex);

fs.writeFileSync(filePath, content, 'utf-8');
console.log("Applied SVG update successfully!");
